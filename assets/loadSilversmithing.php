...
$lengthSQL = "SELECT COUNT(*) AS total FROM	blog_table WHERE page='silversmithing'";
...
$sql = "SELECT * FROM blog_table WHERE page='silversmithing' ORDER BY date DESC LIMIT $i,1 ";
