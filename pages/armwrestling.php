...
<html>
    ...
    <!-- Armwrestling-->
    <p class="pageHeader">Armwrestling</p>
  
    <div class="programming">
        <!--TODOOOOO change src-->
        <iframe style="height:100%;width:100%;" src="https://larsholen.com/public/loadArmwrestling.php" frameborder="yes" scrolling="yes" name="myIframe" id="myIframe"> </iframe>       
    </div>
